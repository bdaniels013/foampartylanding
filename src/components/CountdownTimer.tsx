...
export default function CountdownTimer({ className }: CountdownTimerProps) {
  ...
  useEffect(() => {
    // Set end date to 15 minutes from now for maximum urgency
  ...
  return (
    ...
    >
      ...
      >
        <div className="inline-block bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 text-white px-6 py-3 rounded-full font-bold text-lg shadow-lg">
